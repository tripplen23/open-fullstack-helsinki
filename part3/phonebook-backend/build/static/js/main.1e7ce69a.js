/*! For license information please see main.1e7ce69a.js.LICENSE.txt */
!(function () {
  'use strict'
  var e = {
      463: function (e, n, t) {
  ...
  !(function () {
      ...
      function s(e, t, a) {
        ...
        if (e && !a && 'object' === typeof e)
          if (H.endsWith(t, '{}'))
            ...
            ((H.isFileList(e) || H.endsWith(t, '[]')) && (i = H.toArray(e)))
          )
            return (
              (t = Z(t)),
      ...
      return (
        (function e(t, r) {
          if (!H.isUndefined(t)) {
            ...
            c.push(t),
              H.forEach(t, function (t, l) {
                !0 ===
                  (!(H.isUndefined(t) || null === t) &&
                    a.call(n, t, H.isString(l) ? l.trim() : l, r, f)) &&
                  e(t, r ? r.concat(l) : [l])
              }),
              c.pop()
          }
      ...
      transformRequest: [
        function (e, n) {
          var t,
            ...
            l = H.isObject(e)
          if ((l && H.isHTMLForm(e) && (e = new FormData(e)), H.isFormData(e)))
            ...
            try {
              ...
              if (a) {
                if ('SyntaxError' === l.name)
                  throw Y.from(l, Y.ERR_BAD_RESPONSE, this, null, this.response)
                throw l
              }
            }
          }
              ...
              value: function (e) {
                ...
                return (
                  H.forEach(this, function (r, a) {
                    var l = H.findKey(t, a)
                    if (l) return (n[l] = be(r)), void delete n[a]
                    var o = e
                      ? (function (e) {
                          return e
                            .trim()
    ...
    var Fe = function (e) {
      for (
        ...
        a < r && ((n = e[a]), !(t = H.isString(n) ? ze[n.toLowerCase()] : n));
        a++
      );
      if (!t) {
        if (!1 === t)
    ...
    function je(e) {
      return (
        ...
        Fe(e.adapter || me.adapter)(e).then(
          function (n) {
            return (
              De(e),
    ...
    var Be = {}
    Ie.transitional = function (e, n, t) {
      function r(e, n) {
        return (
    ...
    H.forEach(['delete', 'get', 'head', 'options'], function (e) {
      $e.prototype[e] = function (n, t) {
        return this.request(
          Me(t || {}, { method: e, url: n, data: (t || {}).data })
        )
      }
    }),
      H.forEach(['post', 'put', 'patch'], function (e) {
    ...
    var Je = (function e(n) {
      var t = new We(n),
        r = c(We.prototype.request, t)
      return (
        H.extend(r, We.prototype, t, { allOwnKeys: !0 }),
    ...
    ;(Je.Axios = We),
      ...
      (Je.formToJSON = function (e) {
        return de(H.isHTMLForm(e) ? new FormData(e) : e)
      }),
      (Je.HttpStatusCode = Ke),
      (Je.default = Je)
    var Ye = Je,
      Xe = 'api/persons',
      Ge = function () {
        return Ye.get(Xe).then(function (e) {
          return e.data
        })
      },
      Ze = function (e) {
        return Ye.post(Xe, e).then(function (e) {
          return e.data
        })
      },
      en = function (e, n) {
        return Ye.put(''.concat(Xe, '/').concat(e), n).then(function (e) {
          return e.data
        })
      },
      nn = function (e) {
        return Ye.delete(''.concat(Xe, '/').concat(e)).then(function (e) {
          return e.data
        })
      },
      tn = t(184),
      rn = function (e) {
        var n = e.addContent,
          ...
          r = e.handleTypeName,
          a = e.newNumber,
          l = e.handleTypeNumber
        return (0, tn.jsx)('div', {
          children: (0, tn.jsxs)('form', {
            onSubmit: n,
            children: [
              (0, tn.jsxs)('div', {
                children: [
                  'Name: ',
                  (0, tn.jsx)('input', { value: t, onChange: r }),
                ],
              }),
              (0, tn.jsxs)('div', {
                children: [
                  'Number: ',
                  (0, tn.jsx)('input', { value: a, onChange: l }),
                ],
              }),
              (0, tn.jsx)('div', {
                children: (0, tn.jsx)('button', {
                  type: 'submit',
                  children: 'Add',
                }),
              }),
      ...
      an = function (e) {
        ...
        return (0, tn.jsxs)('p', {
          children: [
            ...
            n.number,
            ' ',
            (0, tn.jsx)('button', { onClick: t, children: 'Delete' }),
          ],
        })
      },
      ln = function (e) {
        var n = e.filterName,
          t = e.handleTypeFilterName
        return (0, tn.jsxs)('div', {
          children: [
            'Filter shown with ',
            (0, tn.jsx)('input', { value: n, onChange: t }),
          ],
        })
      },
      on = function (e) {
        ...
        var t = n.includes('add') ? 'noti__add' : 'noti__delete'
        return (0, tn.jsx)('div', { className: t, children: n })
      },
      un = function () {
        var n = s((0, e.useState)([]), 2),
          ...
          p = d[0],
          h = d[1],
          m = s((0, e.useState)(null), 2),
          v = m[0],
          g = m[1]
        ;(0, e.useEffect)(function () {
          console.log('Effect'),
            Ge().then(function (e) {
              console.log('Promise fulfiled'), console.log(e), r(e)
            })
        }, [])
        console.log(t)
        var y = t.filter(function (e) {
          return e.name.toLowerCase().includes(p.toLowerCase())
        })
        return (0, tn.jsxs)('div', {
          children: [
            (0, tn.jsx)('h2', { children: 'Phonebook' }),
            (0, tn.jsx)(on, { message: v }),
            (0, tn.jsx)('br', {}),
            (0, tn.jsx)(ln, {
              filterName: p,
              handleTypeFilterName: function (e) {
                h(e.target.value)
              },
            }),
            (0, tn.jsx)('h2', { children: 'Add a new' }),
            (0, tn.jsx)('div', {
              className: 'content__form',
              children: (0, tn.jsx)(rn, {
                addContent: function (e) {
                  ...
                  if (n) {
                    if (
                      ...
                      var u = i(i({}, n), {}, { number: c })
                      en(n.id, u)
                        .then(function (e) {
                          r(
                            t.map(function (t) {
                              return t.id !== n.id ? t : e
                            })
                          ),
                            o(''),
                            f('')
                        ...
                        .catch(function (e) {
                          g(''.concat(e.response.data.error)),
                            setTimeout(function () {
                              g(null)
                            }, 5e3)
                        })
                    }
                  } else if (a) alert(''.concat(c, ' is already in the list'))
                  else {
                    Ze({ name: l, number: c })
                      .then(function (e) {
                        r(t.concat(e)),
                          o(''),
                          f(c),
                          g("'".concat(l, "' is added successfully!")),
                          setTimeout(function () {
                            g(null)
                          }, 5e3)
                      })
                ...
                newName: l,
                handleTypeName: function (e) {
                  console.log(e.target.value), o(e.target.value)
                },
                newNumber: c,
                handleTypeNumber: function (e) {
                  console.log(e.target.value), f(e.target.value)
                },
              }),
            }),
            (0, tn.jsx)('h2', { children: 'Numbers' }),
            (0, tn.jsx)('div', {
      ...
      sn = document.getElementById('root')
    ;(0, n.s)(sn).render(
      (0, tn.jsx)(e.StrictMode, { children: (0, tn.jsx)(un, {}) })
    )
  })()
})()
//# sourceMappingURL=main.1e7ce69a.js.map
